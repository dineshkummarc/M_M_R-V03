...
.os, .set, #restart_detail, #social-home, .go-back { display: none !important;}
	...
	<script>
		$(function(){
			...
			setTimeout(function(){play('http://www.therestartpage.com/OS/media/win95/logoff.wav')},700);					
...
<body>
	...
	<div class = "container">
		<div id = "shutdown">
			<p>
			<img src = "images/win95-shutdown_1.gif" id = "shutdown1" class = "shutdown"/>
			<img src = "images/win95-shutdown_2.jpg" id = "shutdown2" class = "shutdown"/>
			</p>
		</div> <!-- Bios Ends-->
	</div> <!-- Class Ends -->
</body>