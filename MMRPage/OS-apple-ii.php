...
<style type="text/css">
	...
	#appleii_1 {
		...
		background-image: url(images/bios_apple2.gif);
	...
	#appleii_2_top {
		...
		top:0;left:0;
		background-color: #0000FF;
		background-image: url(images/bios_top.gif);
		background-position: center center;
		background-repeat: no-repeat;
		display: none;
		height: 50%;
	...
	#appleii_2_bottom {
		...
		top:0;left:0;
		background-color: #0000FF;
		background-image: url(images/bios_bottom.gif);
		background-position: center center;
		background-repeat: no-repeat;
		display: none;
		height: 50%;
	...
	#appleii_3_loader {
			position:absolute;
		top:0;left:0;
		background-image: url(images/appleii_loading_slow.gif);
		background-position: center center;
		background-repeat: no-repeat;
		display: none;
		height: 100%;
